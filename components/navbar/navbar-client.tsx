...
//           {category.globalInitiatives && category.globalInitiatives.length > 0 && (
//               <div className="mt-6">
//                 {/* Title and separator on the same line */}
//                 <div className="flex items-center gap-4 mb-4">
//                   <h3 className="text-sm font-semibold text-gray-900 whitespace-nowrap">Global Initiatives</h3>
//                   <div className="h-px bg-gray-200 flex-grow"></div>
//                 </div>

//                 {/* Initiatives using maximum space */}
//                 <div className="grid grid-cols-2 gap-10 w-full">
//                   {category.globalInitiatives.map((initiative) => (
//                     <div key={initiative._id || initiative.label} className="flex flex-col">
//                       <h4 className="font-medium text-gray-900 mb-3">{initiative.label}</h4>
//                       {initiative.image && (
//                         <div className="h-32 w-full relative flex-shrink-0 rounded-md overflow-hidden">
//                           <Image
//                             src={initiative.image || "/placeholder.svg"}
//                             alt={initiative.label}
//                             fill
          ...
          <div className="space-y-1 px-2 pb-3 pt-2">
            ...
            {/* <Link
              ...
              className={`block px-3 py-2 text-base font-medium ${
                scrolled ? "text-white hover:bg-[#004db3]" : "text-gray-900 hover:bg-gray-50"
              }`}
              onClick={() => setMobileMenuOpen(false)}
            >
              Tasks
