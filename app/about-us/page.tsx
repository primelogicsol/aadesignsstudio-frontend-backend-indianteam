    ...
    <StaticPageLayout title="About Us">
      <div className="space-y-8">
        <section>
          ...
          <p className="mb-4">
            AA Design Studio is a leading technology company that specializes in providing innovative software
        ...
        <section>
          ...
          <p className="mb-4">
            At AA Design Studio, we follow a collaborative and client-centric approach to every project. We begin
        ...
        <section>
          ...
          <p className="mb-4">
            ...
            and grow. We invite you to partner with AA Design Studio and experience the difference that our
