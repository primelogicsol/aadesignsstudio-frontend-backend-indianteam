      ...
      <div className="space-y-6">
        ...
        <div className="bg-[#002B5B] bg-opacity-5 p-6 rounded-lg mb-8 border-l-4 border-[#002B5B]">
          <p className="text-gray-700 mb-0">
            At AA Design Studio, we value your privacy and are committed to protecting your personal information.
        ...
        <div className="bg-[#002B5B] text-white p-6 rounded-lg">
          ...
          <div className="space-y-1">
            <p>
              Email: <span className="text-[#FF6B00]">privacy@AA Design Studioutions.com</span>
            </p>
          </div>
        </div>
      </div>
