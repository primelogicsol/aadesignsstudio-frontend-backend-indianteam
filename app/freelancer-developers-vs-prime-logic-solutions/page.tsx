...
export default function FreelancerVsPrimeLogicPage() {
  ...
  return (
    <StaticPageLayout title="Freelancer Developers vs AA Design Studio">
      <div className="space-y-8">
        ...
        <div className="prose max-w-none">
          <h2 className="text-2xl font-bold text-[#003087] mb-4">
            Freelancer Developers vs AA Design Studio Service Agreement
          </h2>

          {/* Rest of the content remains the same */}
          <p className="text-gray-700">
            This Service Agreement (the "Agreement") is entered into between AA Design Studio ("Service Provider"
            or "AA Design Studio") and the Freelancer Developer ("Freelancer" or "Contractor"). This Agreement
          ...
          <p>AA Design Studio engages the Freelancer to provide the following services:</p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Communicating regularly with AA Design Studio and providing progress reports.</li>
            <li>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              ...
              intellectual property of the project deliverables to AA Design Studio.
            </li>
            <li>
              <strong>License:</strong> AA Design Studio retains the right to use the Freelancer's work for
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              ...
              <ul className="list-circle pl-6 space-y-1 mt-2">
                <li>
                  AA Design Studio agrees not to disclose any confidential information shared by the Freelancer in
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              ...
              AA Design Studio fails to make payments or breaches the terms of the Agreement.
            </li>
            <li>
          ...
          <p>
            AA Design Studio will not be liable for any indirect, special, incidental, or consequential damages
            arising from the Freelancer's work. The liability of AA Design Studio will be limited to the amount
        ...
        <div className="bg-blue-50 p-6 rounded-lg mt-8">
          <h3 className="text-xl font-bold text-[#003087] mb-4">Why Work With AA Design Studio?</h3>
