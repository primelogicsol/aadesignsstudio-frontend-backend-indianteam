...
export default function CareersPage() {
  return (
    <StaticPageLayout title="Careers at AA Design Studio">
      <div className="space-y-8">
        <p className="text-base sm:text-lg text-gray-600">
          At AA Design Studio, we believe in building a future through technology. Join our team of talented
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 mb-8 md:mb-16">
          ...
          <div className="bg-white p-5 sm:p-8 rounded-lg shadow-sm border border-gray-200">
            ...
            <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">
              At AA Design Studio, we foster a culture that values innovation, collaboration, and continuous
        ...
        <div className="bg-white p-4 sm:p-8 rounded-lg shadow-md border border-gray-200 mb-8 md:mb-16">
          ...
          <div className="prose max-w-none">
            <p>
              AA Design Studio is a leading provider of software development, digital marketing, and IT consulting
            ...
            <div className="mt-6 sm:mt-8 space-y-8 sm:space-y-12">
              ...
              <div className="border-b pb-8">
                ...
                <p>
                  As the Chief Operational Officer (COO) at AA Design Studio, you will be responsible for
                ...
                <div className="mt-6 bg-gray-50 rounded-lg border border-gray-200 p-4">
                  ...
                  <a
                    href="mailto:careers@AA Design Studio.com?subject=Application for Chief Operational Officer"
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    Please include your resume and cover letter in your email to careers@AA Design Studio.com
                  </p>
                </div>
              </div>
              ...
              <div className="border-b pb-8">
                ...
                <div className="mt-6 bg-gray-50 rounded-lg border border-gray-200 p-4">
                  <p className="font-medium text-gray-700 mb-3">Ready to apply for this position?</p>
                  <a
                    href="mailto:careers@AA Design Studio.com?subject=Application for Delivery Manager"
                    className="inline-flex items-center justify-center w-full sm:w-auto px-4 py-3 bg-[#FF6B00] text-white rounded-md hover:bg-[#FF6B00]/90 transition-colors"
                  >
                    <Mail className="h-5 w-5 mr-2" />
                    <span>Send Your Application</span>
              ...
              <div className="border-b pb-8">
                ...
                <div className="mt-6 bg-gray-50 rounded-lg border border-gray-200 p-4">
                  <p className="font-medium text-gray-700 mb-3">Ready to apply for this position?</p>
                  <a
                    href="mailto:careers@AA Design Studio.com?subject=Application for Operational Lead"
                    className="inline-flex items-center justify-center w-full sm:w-auto px-4 py-3 bg-[#FF6B00] text-white rounded-md hover:bg-[#FF6B00]/90 transition-colors"
                  >
                    <Mail className="h-5 w-5 mr-2" />
                    <span>Send Your Application</span>
              ...
              <div className="border-b pb-8">
                ...
                <h4 className="font-semibold text-base sm:text-lg text-[#002B5B]">Job Description:</h4>
                <p>
                  AA Design Studio is looking for an Overseas Representative to manage and grow our presence in
                ...
                <h4 className="font-semibold text-base sm:text-lg text-[#002B5B] mt-4">Key Responsibilities:</h4>
                <ul className="list-disc pl-6">
                  <li>Represent AA Design Studio in international markets.</li>
                ...
                <div className="mt-6 bg-gray-50 rounded-lg border border-gray-200 p-4">
                  <p className="font-medium text-gray-700 mb-3">Ready to apply for this position?</p>
                  <a
                    href="mailto:careers@AA Design Studio.com?subject=Application for Overseas Representative"
                    className="inline-flex items-center justify-center w-full sm:w-auto px-4 py-3 bg-[#FF6B00] text-white rounded-md hover:bg-[#FF6B00]/90 transition-colors"
                  >
                    <Mail className="h-5 w-5 mr-2" />
                    <span>Send Your Application</span>
              ...
              <div>
                ...
                <div className="mt-6 bg-gray-50 rounded-lg border border-gray-200 p-4">
                  <p className="font-medium text-gray-700 mb-3">Ready to apply for this position?</p>
                  <a
                    href="mailto:careers@AA Design Studio.com?subject=Application for International Business Development Officer"
                    className="inline-flex items-center justify-center w-full sm:w-auto px-4 py-3 bg-[#FF6B00] text-white rounded-md hover:bg-[#FF6B00]/90 transition-colors"
                  >
                    <Mail className="h-5 w-5 mr-2" />
                    <span>Send Your Application</span>
            ...
            <div className="mt-8 p-4 bg-gray-50 rounded-lg border border-gray-200">
              <p className="text-center">
                AA Design Studio is an equal opportunity employer, committed to fostering a diverse and inclusive
        ...
        <div className="bg-[#002B5B] text-white p-4 sm:p-8 rounded-lg">
          ...
          <p className="mb-4 sm:mb-6 text-center text-sm sm:text-base">
            Ready to take the next step in your career? Join AA Design Studio and be part of a team that's shaping
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
            ...
            <a
              href="mailto:careers@AA Design Studio.com"
