      ...
      <div className="space-y-8">
        <div className="text-center mb-8">
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            At AA Design Studio, we are committed to being a responsible corporate citizen. Our Environmental,
        ...
        <div className="mb-16">
          ...
          <p className="text-gray-700 mb-6">
            At AA Design Studio, we believe in empowering communities and making a meaningful difference in the
        ...
        <div className="mb-16">
          ...
          <div className="space-y-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              <p className="text-gray-700 mb-4">
                Integrity is at the heart of AA Design Studio. We adhere to strict ethical guidelines and ensure
        ...
        <div className="bg-[#002B5B] text-white p-8 rounded-lg text-center">
          ...
          <div className="mt-4">
            ...
            <p className="text-[#FF6B00] font-semibold">esg@AA Design Studioutions.com</p>
          </div>
        </div>
      </div>
    </StaticPageLayout>
