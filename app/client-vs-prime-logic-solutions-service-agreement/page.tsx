...
export default function ClientServiceAgreementPage() {
  ...
  return (
    <StaticPageLayout title="Client vs AA Design Studio Service Agreement">
      <div className="space-y-8">
        ...
        <div className="prose max-w-none">
          <h2 className="text-2xl font-bold text-[#003087] mb-4">Client vs AA Design Studio Service Agreement</h2>

          {/* Rest of the content remains the same */}
          <p className="text-gray-700">
            This Service Agreement (the "Agreement") is entered into between AA Design Studio ("Service Provider")
          ...
          <div className="bg-blue-50 p-4 rounded-md my-6">
            ...
            <p>
              <strong>Service Provider:</strong> AA Design Studio
            </p>
            <p>
          ...
          <p>AA Design Studio will provide the following services to the Client:</p>
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              <strong>Specific Deliverables:</strong> AA Design Studio will deliver the agreed-upon work according
          ...
          <h3 className="text-xl font-semibold text-[#003087] mt-8">5. AA Design Studio Responsibilities</h3>
          <p>AA Design Studio will:</p>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>Ownership:</strong> Upon full payment, AA Design Studio transfers all rights, ownership, and
              intellectual property of the project deliverables to the Client.
            </li>
            <li>
              <strong>License:</strong> AA Design Studio retains the right to use the work for marketing or
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              <strong>Obligations of AA Design Studio:</strong>
              <ul className="list-circle pl-6 space-y-1 mt-2">
                <li>
                  AA Design Studio agrees not to disclose, share, or use any confidential information for any
                  purpose other than performing their duties under this Agreement.
                </li>
                <li>
                  AA Design Studio will take all necessary precautions to safeguard the confidential information
            ...
            <li>
              ...
              <ul className="list-circle pl-6 space-y-1 mt-2">
                <li>
                  The Client agrees not to disclose any confidential information shared by AA Design Studio in the
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>Service Provider Warranties:</strong> AA Design Studio warrants that the deliverables will
              meet the agreed specifications and will be free of defects.
            </li>
            <li>
              <strong>Post-Delivery Support:</strong> AA Design Studio will provide [X] weeks/months of support
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              <strong>By AA Design Studio:</strong> AA Design Studio may terminate this Agreement if the
          ...
          <p>
            ...
            AA Design Studio' work. The liability of the Client will be limited to the amount paid for the work in
            question.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-6 mb-12">
            <div className="border p-4 rounded-md">
              <p className="font-semibold mb-4">For AA Design Studio</p>
        ...
        <div className="bg-blue-50 p-6 rounded-lg mt-8">
          <h3 className="text-xl font-bold text-[#003087] mb-4">Why Choose AA Design Studio?</h3>
