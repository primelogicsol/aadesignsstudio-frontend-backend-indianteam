      ...
      <div className="space-y-6">
        ...
        <div className="bg-[#002B5B] bg-opacity-5 p-6 rounded-lg mb-8 border-l-4 border-[#002B5B]">
          <p className="text-gray-700 mb-0">
            At AA Design Studio, we are committed to providing high-quality software development and digital
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            ...
            <li>
              Refunds are only considered for services provided by AA Design Studio, and the conditions for each
              service are as follows.
            </li>
            <li>
              All refund requests must be made in writing to{" "}
              <span className="text-[#FF6B00] font-semibold">support@AA Design Studioutions.com</span> within 14 days from
        ...
        <div className="bg-[#002B5B] text-white p-6 rounded-lg">
          ...
          <div className="space-y-1">
            <p>
              Email: <span className="text-[#FF6B00]">support@AA Design Studioutions.com</span>
            </p>
