    ...
    <StaticPageLayout title="Privacy Policy">
      <div className="prose max-w-none">
        ...
        <p className="text-gray-700 mb-4">
          At AA Design Studio, we take your privacy and data security seriously. This Privacy Policy outlines how
        ...
        <p className="text-gray-700 mb-4">
          If AA Design Studio undergoes a merger, acquisition, or restructuring, user data may be transferred as
        ...
        <div className="mb-6">
          <p className="font-semibold text-gray-800">AA Design Studio</p>
