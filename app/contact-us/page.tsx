    ...
    <StaticPageLayout title="Contact Us">
      <div className="space-y-10">
        ...
        <div className="text-center mb-10">
          <h2 className="text-2xl font-bold text-[#003087] mb-4">Get in Touch with AA Design Studio</h2>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          ...
          <div className="space-y-6">
            <div>
              <h4 className="font-semibold text-lg mb-2">What services does AA Design Studio offer?</h4>
