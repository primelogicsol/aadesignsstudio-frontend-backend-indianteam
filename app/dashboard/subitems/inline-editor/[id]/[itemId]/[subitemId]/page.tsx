...
export default async function EditSubitemInlinePage({ params }: PageProps) {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold mb-8">Edit Subitem with Live Preview</h1>
      <SubitemInlineEditor subitem={subitem} categories={categories} />
    </div>
  )
}
