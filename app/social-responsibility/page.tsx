      ...
      <div className="space-y-8">
        <div className="text-center mb-8">
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            At AA Design Studio, we believe that technology should serve humanity. Our social responsibility
        ...
        <div className="bg-[#002B5B] text-white p-8 rounded-lg">
          ...
          <p className="mb-6 text-center">
            At AA Design Studio, we believe that technology has the power to transform lives and communities. We
