    ...
    <StaticPageLayout title="Terms and Conditions">
      <div className="prose max-w-none">
        ...
        <p className="text-gray-700 mb-4">
          Welcome to AA Design Studio ("Company", "we", "us", or "our"). These Terms and Conditions ("Terms")
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
          <li>
            All software, content, trademarks, and proprietary materials developed by AA Design Studio remain our
            exclusive property.
          </li>
          <li>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
          <li>
            AA Design Studio is not liable for any indirect, incidental, or consequential damages arising from
            service use.
          </li>
          <li>
        ...
        <p className="text-gray-700 mb-6">
          ...
          <br />
          Email: legal@AA Design Studioutions.com
          <br />
